...
class DriverPerfomance extends Component {
  ...
  _evaluateMode() {
    ...
    if (!this.state.cardMode && windowWidth <= 800) {
      this.setState({ cardMode: true });
    } else if (this.state.cardMode && windowWidth > 800) {
  ...
  render() {
    ...
    if (Object.keys(DriverCommissionResults).length > 0) {
      ...
      combinedUser.forEach((filteredPerson) => {
        ...
        //console.log(groupalcoholStatus[filteredPerson.username], "  groupalcoholStatus[filteredPerson.username]");
        recent.push(
          <RowComponent
            updateDB={true}
        ...
        <div className={classes.profile}>
          <div>
            ...
            >
              ...
              <Toolbar>
                <div className={classes.tabCenter}>
                  <Typography
                    variant="subtitle1"
                    align="center"
