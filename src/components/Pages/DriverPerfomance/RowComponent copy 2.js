...
class RowComponent extends Component {
  ...
  printElement = (drunkenDate, drunkenTime) => {
  ...
  render() {
    ...
    let ListPrint = this.props.alcoholPerMonthFromParent ?  //console.log(alcoholPerMonthFromParent, " alcoholPerMonthFromParent");
      alcoholPerMonthFromParent.forEach((item) => {
        ...
        //   minute: "numeric",
        // });
        //console.log(drunkenDate, " ", drunkenTime, " iiitem.Time");
    ...
    console.log(ListPrint, " List Print");
