    ...
    if (role === "driver") {
      ratingUser = (
        <Box component="fieldset" mb={3} borderColor="transparent">
          ...
          <Rating name="read-only" value={ranking !== null ? ranking : this.state.ranking} readOnly />
...
User.propTypes = {
  ...
  rankingDriver: PropTypes.object.isRequired,
  member: PropTypes.object.isRequired,
};

const mapStateToProps = (state) => ({
  member: state.data.member,
  rankingDriver: state.data.rankingDriver,
  UI: state.UI,
});
